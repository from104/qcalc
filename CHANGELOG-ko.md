...
- 앱을 여는 동안 보이는 시작 화면 추가

### 변경됨

- 앱 시작 속도 개선
- 버튼·탭·화면 전환 애니메이션을 더 빠르고 부드럽게 개선
- 좁은 화면과 넓은 화면을 오갈 때 계산기가 자연스럽게 커지고 줄어들도록 변경
- 계산 기록이 많을 때 [=] 입력 반응 속도 개선
- Linux의 NVIDIA 그래픽 환경에서 화면 표시 성능 개선
- 저사양 기기에서 애니메이션 자동 축소

### 수정됨

- 앱을 시작할 때 흰 화면이 깜빡이던 문제 수정
- 드물게 시작 화면에서 넘어가지 않던 문제 수정
- [기록] 화면 오른쪽 여백이 없던 문제 수정
