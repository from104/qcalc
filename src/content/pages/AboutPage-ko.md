...
- 데스크톱 통합 도구가 AppImage 아이콘을 인식하지 못하던 문제 수정
...
- Linux에서 실행할 때마다 창이 조금씩 커지다 최대 크기에서 멈추던 문제 수정
- Linux에서 최소·최대 창 크기가 내용 영역에 적용되지 않던 문제 수정 (0.13.2부터는 아예 적용되지 않던 문제 포함)
