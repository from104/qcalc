...
- **Cómo acceder**: Ctrl+5 o seleccionar desde el menú de desbordamiento (▾) en las pestañas superiores
- **Entrada de expresiones**: Introduce expresiones matemáticas directamente usando la sintaxis de mathjs
