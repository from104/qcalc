...
- **Como Acessar**: Ctrl+5 ou selecione no menu de overflow (▾) nas abas superiores
- **Entrada de Expressão**: Digite expressões matemáticas diretamente usando a sintaxe mathjs
...
- **Navegação no Histórico**: Use as teclas de seta ↑/↓ no modo de edição para navegar por expressões anteriores, reinicia automaticamente ao editar
