...
<template>
  ...
  >
    ...
    <!--
      내비게이션 바 높이를 offset 에 더하지 않는다. 이 FAB 는 position: fixed 지만 두 레이아웃
      모두 q-scroll-area 안에 있고, QScrollArea 는 contain: strict 라 fixed 의 기준 상자가
      뷰포트가 아니라 그 스크롤 영역이 된다(에뮬레이터 CDP 실측: 영역 바닥 852px, FAB 바닥
      834px = 852 - 18). 스크롤 영역 높이가 이미 --bottom-inset 을 뺐으므로 여기서 또 빼면
      두 번 올라간다. FAB 를 스크롤 영역 밖으로 옮기면 그때는 인셋을 더해야 한다.
      (offset 은 Quasar 가 인라인 margin 으로 굳히므로 CSS 클래스로는 못 건드린다.)
    -->
...
ja:
  ...
  search: '検索'
  doYouDeleteRecord: 'すべての計算記録を削除しますか？'
  memo: 'メモ'
  ...
  copyMemo: 'メモコピー'
  deleteMemo: 'メモ削除'
  copyDisplayedResult: '表示結果をコピー'
  copyResultNumber: '結果の数値をコピー'
  ...
  fontSize:
    ...
    decrease: '文字を小さく'
  ariaLabel:
    scrollToTop: '一番上にスクロール'
    editMemo: 'メモ編集'
    deleteRecord: '記録を削除'
    searchInput: '検索'
    dragHandle: '検索ウィンドウを移動'
    closeSearch: '検索ウィンドウを閉じる'
zh:
  record: '计算记录'
  noRecord: '没有计算记录。'
  noSearchResult: '没有搜索结果。'
  search: '搜索'
  doYouDeleteRecord: '是否删除所有计算记录？'
  memo: '备注'
  copySuccess: '已复制到剪贴板。'
  ...
  copyMemo: '复制备注'
  deleteMemo: '删除备注'
  copyDisplayedResult: '复制显示结果'
  copyResultNumber: '复制结果数字'
...
hi:
  record: 'गणना रिकॉर्ड'
  noRecord: 'कोई गणना रिकॉर्ड नहीं।'
  noSearchResult: 'कोई खोज परिणाम नहीं।'
  search: 'खोजें'
  doYouDeleteRecord: 'क्या आप सभी गणना रिकॉर्ड हटाना चाहते हैं?'
  memo: 'मेमो'
  copySuccess: 'क्लिपबोर्ड पर कॉपी किया गया।'
  copyFailure: 'क्लिपबोर्ड पर कॉपी करने में विफल।'
  addMemo: 'मेमो जोड़ें'
  editMemo: 'मेमो संपादित करें'
  copyMemo: 'मेमो कॉपी करें'
  deleteMemo: 'मेमो हटाएं'
  copyDisplayedResult: 'प्रदर्शित परिणाम कॉपी करें'
  copyResultNumber: 'परिणाम संख्या कॉपी करें'
  ...
  ariaLabel:
    ...
    searchInput: 'खोजें'
    dragHandle: 'खोज विंडो ले जाएं'
    closeSearch: 'खोज विंडो बंद करें'
de:
  record: 'Berechnungsverlauf'
  noRecord: 'Kein Berechnungsverlauf.'
  noSearchResult: 'Keine Suchergebnisse.'
  search: 'Suchen'
  doYouDeleteRecord: 'Möchten Sie den gesamten Berechnungsverlauf löschen?'
  memo: 'Notiz'
  copySuccess: 'In die Zwischenablage kopiert.'
  copyFailure: 'Kopieren in die Zwischenablage fehlgeschlagen.'
  addMemo: 'Notiz hinzufügen'
  editMemo: 'Notiz bearbeiten'
  copyMemo: 'Notiz kopieren'
  deleteMemo: 'Notiz löschen'
  copyDisplayedResult: 'Angezeigtes Ergebnis kopieren'
  copyResultNumber: 'Ergebnisnummer kopieren'
  ...
  ariaLabel:
    ...
    searchInput: 'Suche'
    dragHandle: 'Suchfenster verschieben'
    closeSearch: 'Suchfenster schließen'
es:
  record: 'Historial de cálculos'
  noRecord: 'No hay historial de cálculos.'
  noSearchResult: 'No hay resultados de búsqueda.'
  search: 'Buscar'
  doYouDeleteRecord: '¿Desea eliminar todo el historial de cálculos?'
  memo: 'Nota'
  ...
  copyResultNumber: 'Copiar número de resultado'
  ...
  ariaLabel:
    ...
    searchInput: 'Buscar'
    dragHandle: 'Mover ventana de búsqueda'
    closeSearch: 'Cerrar ventana de búsqueda'
fr:
  record: 'Historique des calculs'
  noRecord: 'Aucun historique de calculs.'
  noSearchResult: 'Aucun résultat de recherche.'
  search: 'Rechercher'
  doYouDeleteRecord: "Voulez-vous supprimer tout l'historique des calculs ?"
  memo: 'Note'
  copySuccess: 'Copié dans le presse-papiers.'
  copyFailure: 'Échec de la copie dans le presse-papiers.'
  addMemo: 'Ajouter une note'
  editMemo: 'Modifier la note'
  copyMemo: 'Copier la note'
  deleteMemo: 'Supprimer la note'
  copyDisplayedResult: 'Copier le résultat affiché'
  copyResultNumber: 'Copier le nombre résultant'
