...
import { convertRadix, Radix } from '../converters/RadixConverter';

// MathJS 라이브러리 설정 — 시작 속도를 위해 기본 계산기에 필요한 함수만 담은 경량 인스턴스.
// 수식 계산기용 전체 인스턴스는 FormulaMath.ts에서 지연 로드한다.
export const MathB = create(
  {
    absDependencies,
    addDependencies,
    bignumberDependencies,
